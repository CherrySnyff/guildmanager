...
class FocusManager extends AbstractService
{
    ...
    /**
     * Подсказки для карточки гильдии (вкладка «Описание»).
     * Последовательность «\n» (обратный слэш + n) — перенос строки во всплывающем окне; фразы связываются типографским тире «—».
     */
    public const FOCUS_HINTS = [
        'ideology' => 'Приверженность определённым религиозным или культурным ценностям.',
        'art' => 'Развитие живописи, поэзии, хореографии и других видов творчества.',
        'production' => 'Изготовление, ремесленничество и обработка определённых предметов.',
        'economy' => 'Торговляи  продажа товаров.',
        'magic' => 'Изучение магической структуры мира и магических сил.',
        'science' => 'Развитие естественных, точных, гуманитарных,фундаментальных и прикладных наук.',
        'politics' => 'Участие во внутренней и внешней политике городов.',
        'statehood' => 'Официальность и приверженность правительству и законодательству.',
        'crime' => 'Ведение незаконной, нелегальной деятельности.',
        'war' => 'Предоставление услуг,связанных с боевыми действиями.',
        'defense' => 'Защита и охрана как определённых объектов так и городов в целом.',
        'public' => 'Акцент на связи с мирным населением.',
        'status' => 'Акцент на связи с высокопоставленными членами общества, аристократией, выдающимися предпринимателями.',
        'traditions' => 'Следование традициям, аскетизму, отшельничеству связи с природой и естественным миром.',
        'progress' => 'Стремление к развитию передовым технологиям и новым знаниям.',
        'mercenary' => 'Предоставление наёмных услуг различного спектра. Особая направленность, дающая +5 репутации при взаимодействии с любыми фракциями. Бонус повышается на 5 за каждое третье улучшение данной направленности, при этом фракции будут относиться к вам холоднее чем к представителю определенной Направленности.',
    ];
    ...
    public function setGuildFocuses(
        ...
        $guard->assertCanManageDirections($guild, $actor, $guildRole);
